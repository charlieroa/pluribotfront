...
function extractApiKey(req: Request): string | null {
  ...
  if (typeof xApiKey === 'string' && xApiKey.startsWith('pk_')) return xApiKey
 ...
 */
export async function generateApiKey(userId: string, name: string = 'Default'): Promise<{ key: string; id: string; keyPrefix: string }> {
