...
INSERT INTO "new_Deliverable" ("agent", "botType", "content", "conversationId", "createdAt", "id", "instanceId", "isPublic", "netlifySiteId", "netlifyUrl", "shareSlug", "title", "type") SELECT "agent", "botType", "content", "conversationId", "createdAt", "id", "instanceId", "isPublic", "netlifySiteId", "netlifyUrl", "shareSlug", "title", "type" FROM "Deliverable";
...
CREATE INDEX "Deliverable_conversationId_instanceId_idx" ON "Deliverable"("conversationId", "instanceId");
