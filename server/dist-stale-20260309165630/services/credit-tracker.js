 ...
 */
export async function consumeCredits(userId, agentId, model, inputTokens, outputTokens) {
    const credits = calculateTokenCredits(model, inputTokens, outputTokens);
    // Create usage record
 ...
 */
export async function consumeToolCredits(userId, agentId, toolName) {
 ...
 */
export async function adminGrantCredits(userId, amount, reason) {
    const user = await prisma.user.update({
        where: { id: userId },
 ...
 */
export async function maybeResetCredits(userId) {
    const user = await prisma.user.findUnique({
        where: { id: userId },
 ...
 */
export async function resetCreditsForPlan(userId, planId) {
