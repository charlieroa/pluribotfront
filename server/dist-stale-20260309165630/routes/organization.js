...
router.post('/members', orgAdminAuth, async (req, res) => {
    try {
        const { email, name, role, specialty, specialtyColor, specialtyKeywords, avatarUrl } = req.body;
        if (!email || !name) {
...
router.patch('/members/:id', orgAdminAuth, async (req, res) => {
    try {
        ...
        const { specialty, specialtyColor, specialtyKeywords, avatarUrl } = req.body;
...
router.post('/members/:id/assign', orgAdminAuth, async (req, res) => {
    try {
        ...
        const agentMemberId = req.params.id;
