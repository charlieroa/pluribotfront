 ...
 */
export declare function consumeCredits(userId: string, agentId: string, model: string, inputTokens: number, outputTokens: number, cacheCreationInputTokens?: number, cacheReadInputTokens?: number, conversationId?: string): Promise<CreditUsageResult>;
/**
