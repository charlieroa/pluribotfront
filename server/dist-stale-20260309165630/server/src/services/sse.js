...
function bufferEvent(conversationId, event) {
...
export function getBufferedEvents(conversationId, afterId) {
    const buf = eventBuffer.get(conversationId) ?? [];
    return buf.filter(e => e.id > afterId);
}
export function addConnection(conversationId, res, userId, lastEventId) {
