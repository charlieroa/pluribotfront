...
import { ArrowUp, Paperclip, X, Globe, Sparkles, Image, ChevronDown } from 'lucide-react'
...
const WelcomeScreen = ({ inputText, setInputText, onSubmit, onLoadTemplate, selectedImageModel, onImageModelChange }: WelcomeScreenProps) => {
          ...
          <div className="flex items-center justify-between px-3 pb-3">
            <div className="flex items-center gap-0.5">
              ...
              <div className="relative" ref={imageModelMenuRef}>
                ...
                >
                  <Image size={13} className={isImageAuto ? 'text-ink-faint' : 'text-violet-500'} />
                  {isImageAuto ? 'Auto' : currentImageModel?.label ?? 'Auto'}
                  <ChevronDown size={11} />
                </button>
