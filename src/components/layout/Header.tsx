...
import { LogIn, UserPlus, LogOut, Shield, Menu, Bell, Rocket, Palette, Sparkles, Globe, BarChart3, Settings, Moon, Sun, Zap, ChevronDown } from 'lucide-react'
...
const Header = ({ isCoordinating, completionFlash, onMobileMenuToggle, onNewChat, onOpenSettings, onOpenAdmin }: HeaderProps) => {
